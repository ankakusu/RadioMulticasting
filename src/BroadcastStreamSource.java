...
public final class BroadcastStreamSource extends ReceiverAdapter implements StreamSource {
    ...
    public BroadcastStreamSource(String groupName, List<StreamSink> sinks) throws Exception {
        // Create data channel
